...
public class SGConfig {
    ...
    public static final String FIELD_APP_VERSION_STRING = "app_version_string";
    public static final String FIELD_BLUETOOTH_ENABLED = "bluetooth_enabled";
    ...
    public static final String FIELD_LIB_VERSION = "lib_version";
    ...
    public static final String FIELD_MP_LIB = "mp_lib";
