...
public class UpdateDisplayState implements Parcelable {
    ...
    public static abstract class DisplayState implements Parcelable {
        ...
        public static final class InAppNotificationState extends DisplayState {
            ...
            private static String INAPP_KEY = "com.UpdateDisplayState.InAppNotificationState.INAPP_KEY";
            private static String HIGHLIGHT_KEY = "com.UpdateDisplayState.InAppNotificationState.HIGHLIGHT_KEY";
        }
        ...
        public static final class SurveyState extends DisplayState {
            ...
            public void writeToParcel(final Parcel dest, final int flags) {
                ...
                if (mBackground != null) {
                    ...
                    mBackground.compress(Bitmap.CompressFormat.JPEG, 20, bs);
            ...
            private static final String SURVEY_BUNDLE_KEY = "UpdateDisplayState.SURVEY_BUNDLE_KEY";
            private static final String HIGHLIGHT_COLOR_BUNDLE_KEY = "UpdateDisplayState.HIGHLIGHT_COLOR_BUNDLE_KEY";
            private static final String ANSWERS_BUNDLE_KEY = "UpdateDisplayState.ANSWERS_BUNDLE_KEY";
            private static final String BACKGROUND_COMPRESSED_BUNDLE_KEY = "UpdateDisplayState.BACKGROUND_COMPRESSED_BUNDLE_KEY";
        }
        ...
        public static final String STATE_TYPE_KEY = "UpdateDisplayState.DisplayState.STATE_TYPE_KEY";
        public static final String STATE_IMPL_KEY = "UpdateDisplayState.DisplayState.STATE_IMPL_KEY";
    }
    ...
    private static final String LOGTAG = "SugoAPI.UpDisplSt";
    private static final long MAX_LOCK_TIME_MILLIS = 12 * 60 * 60 * 1000; // Twelve hour timeout on survey activities

    private static final String DISTINCT_ID_BUNDLE_KEY = "UpdateDisplayState.DISTINCT_ID_BUNDLE_KEY";
    private static final String TOKEN_BUNDLE_KEY = "UpdateDisplayState.TOKEN_BUNDLE_KEY";
    private static final String DISPLAYSTATE_BUNDLE_KEY = "UpdateDisplayState.DISPLAYSTATE_BUNDLE_KEY";
